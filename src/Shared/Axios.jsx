...
export const getRequestNoAuth = async ({ API = "", DATA = {}, HEADER = {}, PAYLOAD }) => await requestWithoutAuth.get(API)

export const postRequestNoAuth = async ({ API = "", DATA = {}, HEADER = {}, PAYLOAD }) => await requestWithoutAuth.post(API, DATA)
